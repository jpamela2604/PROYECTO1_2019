 ...
 */
public class s_nCrearReproductor implements sent {
    LinkedList<sent> parametros;
    int linea;
     int columna;
     String archivo;
     
     public s_nCrearReproductor(LinkedList<sent> parametros,int linea,int columna,String archivo)
     {
    ...
    public Object ejecutar(mng_ts ts, mng_error e, Ejecucion ej) {
        ...
        if(ts.actual==null||ts.actual.tipo.indice==var.contenedor)
        {
            ...
            {
                e.AddError("El metodo CrearReproductor debe tener 6 parametros", linea, columna, archivo, "SEMANTICO");
                return rr;
            }   
        ...
        {
            e.AddError("ERROR:  crear Reproductor", linea, columna, archivo, "SEMANTICO");
        }
        return rr;
    }
