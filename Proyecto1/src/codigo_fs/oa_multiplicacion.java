 ...
 */
public class oa_multiplicacion implements sent{
    sent op1;
     sent op2;
     int linea;
     int columna;
     ...
     public oa_multiplicacion(sent op1,sent op2,int linea,int columna,String archivo)
     {
         this.op1=op1;
         this.op2=op2;
         this.linea=linea;
    ...
    public Object ejecutar(mng_ts ts, mng_error e, Ejecucion ej) {
        ...
        {
            e.AddError("ERROR:  MULTIPLICACION", linea, columna, archivo, "SEMANTICO");
        }
        return respuesta;
    }
    static  O [][]  matriz={
    ...
    /*1*/{O.ERROR,O.MULTI,O.MULTI,O.ERROR }, 
    /*2*/{O.ERROR,O.MULTI,O.MULTI,O.ERROR },
