 ...
 */
public class ol_or implements sent{
    sent op1;
     sent op2;
     int linea;
     int columna;
     ...
     public ol_or(sent op1,sent op2,int linea,int columna,String archivo)
     {
         this.op1=op1;
         this.op2=op2;
         this.linea=linea;
    ...
    public Object ejecutar(mng_ts ts, mng_error e, Ejecucion ej) {
        ...
        {
            e.AddError("ERROR:  OR", linea, columna, archivo, "SEMANTICO");
        }
        return respuesta;
    }
}
