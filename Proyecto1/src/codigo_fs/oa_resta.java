 ...
 */
public class oa_resta implements sent{
   sent op1;
     sent op2;
     int linea;
     int columna;
     ...
     public oa_resta(sent op1,sent op2,int linea,int columna,String archivo)
     {
         this.op1=op1;
         this.op2=op2;
         this.linea=linea;
    ...
    /*1*/{O.ERROR,O.RESTA,O.RESTA,O.ERROR }, 
    /*2*/{O.ERROR,O.RESTA,O.RESTA,O.ERROR },
