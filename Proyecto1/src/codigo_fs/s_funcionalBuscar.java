 ...
 */
public class s_funcionalBuscar implements sent {
    String id;
    int linea;
     int columna;
     String archivo;
     
     public s_funcionalBuscar(String id,int linea,int columna,String archivo)
     {
         this.id=id;
         this.linea=linea;
    ...
    public Object ejecutar(mng_ts ts, mng_error e, Ejecucion ej) {
        ...
        if(ts.actual!=null)
        {
            ...
            {
                e.AddError("Solo se puede usar la funcion \"BUSCAR\" con arreglos", linea, columna, archivo, "SEMANTICO");
            }else
            {
                ...
                if(m!=null)
                {
                    ...
                    {
                         e.AddError("El metodo que se invoca en la funcion \"BUSCAR\" debe tener un parametro", linea, columna, archivo, "SEMANTICO");
                    }else
                    {
                        //si va a ejecutar
    ...
    public Object Buscar(mng_ts ts, mng_error e, Ejecucion ej,Simbolo funcion)
    {
        Simbolo respuesta=new Simbolo(var.tipo_nulo,null);
