 ...
 */
public class s_nCrearAreaTexto implements sent {
    LinkedList<sent> parametros;
    int linea;
     int columna;
     String archivo;
     
     public s_nCrearAreaTexto(LinkedList<sent> parametros,int linea,int columna,String archivo)
     {
    ...
    public Object ejecutar(mng_ts ts, mng_error e, Ejecucion ej) {
        ...
        {
                e.AddError("No se puede agregar un area de texto a un elemento de tipo "+ts.actual.tipo.nombre, linea, columna, archivo, "SEMANTICO");
        }
        }catch(Exception exce)
        {
            e.AddError("ERROR:  crearAreaTexto", linea, columna, archivo, "SEMANTICO");
        }
        return rr;
    }
}
