 ...
 */
public class ui_reproductor extends JButton implements ui{
    ...
    public ui_reproductor(String ruta,int x,int y,Boolean autoplay,int alto,int ancho,String nombre)
    {
