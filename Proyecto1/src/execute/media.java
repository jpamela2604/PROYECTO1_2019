...
public class media {
            ...
            Integer ancho,Integer alto,Integer x,Integer y,String file,Boolean auto)
    {
        ...
        pausa.setBounds(0,alto-25,anchoBoton,25);
        JButton continuar=new JButton();
        continuar.setText("continuar");
        continuar.setVisible(false);
        continuar.setBounds(anchoBoton,alto-25,anchoBoton,25);
        JButton detener=new JButton();
        detener.setText("detener");
        detener.setVisible(false);
        detener.setBounds(2*anchoBoton,alto-25,anchoBoton,25);
        Canvas c= new Canvas();
